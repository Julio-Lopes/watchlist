...
import { entryListSchema, mediaDetailSchema } from '@watchlist/shared';
...
export default async function MediaPage({
  ...
  /** Viewer e biblioteca em paralelo. Anonimo recebe null nos dois e a pagina
   *  segue: esta e a porta de entrada organica e nao pode exigir sessao. */
  const [viewer, library] = await Promise.all([
    getViewer(),
